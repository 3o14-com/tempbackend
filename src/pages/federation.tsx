...
data.get("/", async (c) => {
  ...
  return c.html(
    <DashboardLayout title="3o14: Federation" selectedMenu="federation">
      <hgroup>
        <h1>Federation</h1>
        <p>
      ...
      <article>
        ...
        >
          ...
          {error === "refresh" ? (
            ...
            <small>
              A fediverse handle (e.g., <tt>@faulty@3o14.com</tt>) or a
              post/actor URI (e.g.,{" "}
              <tt>
                https://3o14.com/@faulty/01904586-7b75-7ef6-ad31-bec40b8b1e66
              </tt>
              ) is allowed.
            </small>
          )}
      ...
      <article>
        ...
        <p>
          3o14 does not provide so-called <q>self-destruct</q> feature.
