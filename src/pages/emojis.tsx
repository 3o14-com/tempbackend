...
const logger = getLogger(["3o14", "pages", "emojis"]);
...
emojis.get("/", async (c) => {
  ...
  return c.html(
    <DashboardLayout title="3o14: Custom emojis" selectedMenu="emojis">
      <hgroup>
        <h1>Custom emojis</h1>
        <p>You can register custom emojis for your 3o14 accounts.</p>
      </hgroup>
      <form
        method="post"
...
emojis.get("/new", async (c) => {
  ...
  return c.html(
    <DashboardLayout title="3o14: Add custom emoji" selectedMenu="emojis">
      <hgroup>
        <h1>Add custom emoji</h1>
        <p>You can add a custom emoji to your 3o14 server.</p>
      </hgroup>
...
emojis.get("/import", async (c) => {
  ...
  return c.html(
    <DashboardLayout title="3o14: Import custom emojis" selectedMenu="emojis">
      <hgroup>
