...
function SetupPage(props: SetupPageProps) {
  return (
    <Layout title="Welcome to 3o14!">
      {props.proxyWarning && (
        <article class="pico-background-red-700">
          <p class="pico-background-red-700" style="margin: 0">
            <strong>Warning:</strong> Your 3o14 server apparently runs behind a
      ...
      <hgroup>
        <h1>Welcome to 3o14!</h1>
        <p>
          It's the first time to use 3o14, let's set up your account. The email
          and password you set here will be used to sign in to 3o14.
        </p>
      </hgroup>
